...
import { FILE_PATH } from "../../../utils/url";
...
const fetchData = async () => {
  ...
  if (res.success) {
    ...
    perPage.value = res.branches.per_page;
    total.value = res.branches.total;
  } else {
...
const branchDelete = async (id) => {
  const res = await store.deleteBranch(id);
  if (res.success) {
    res.message.forEach((val) => {
      toast.success(val);
    });
    ...
    <div class="shadow-md m-5 rounded-md">
      <div class="py-3 bg-[#23292F] flex items-center justify-between px-3 rounded-t-md">
        ...
        <div class="text-white">
          ...
          <span class="ml-3 text-md">
            Dashboard /
            <router-link to="/branch/list"> Branch</router-link> /
            <router-link to="/branch/create" class="text-green-600">
      ...
      <div class="p-5 bg-white">
        <div class="container mx-auto">
          ...
          <div
            v-else
            class="overflow-x-scroll w-full flex items-center justify-center font-sans"
          >
            <div class="w-full">
                ...
                <table class="w-full">
                  ...
                  <tbody class="text-gray-600 text-sm font-light">
                    ...
                    >
                      ...
                      <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                          <img :src="FILE_PATH + branch.logo" class="w-8 h-8" alt="" />
                        </div>
                      </td>
                      <td class="py-3 px-6 text-left">
                        <div class="flex items-center">
                      ...
                      <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                          ...
                          <router-link
                            :to="{ name: 'update-branch', params: { id: branch.id } }"
